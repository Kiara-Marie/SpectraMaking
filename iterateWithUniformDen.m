function iterateWithUniformDen(density,t_max,rangeOfPQN)

% runs simulation with density in um^-3, t_max in ns, only 1 shell
...
dirname = ['Uniform_den_' , strrep(num2str(density),'.','p')];
pqnIndex = 1;
for pqn = rangeOfPQN
